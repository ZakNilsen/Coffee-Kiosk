...
/**
 * Is driver class that combines all other classes in neat and easy to use format for customer
 * to understand so that they have no problem ordering from the kiosk
 * @author zaknilsen
 *
 */
